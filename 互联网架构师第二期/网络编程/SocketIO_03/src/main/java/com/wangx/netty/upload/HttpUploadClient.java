...
public final class HttpUploadClient {
	...
	/**
	 * Standard usage of HTTP API in Netty without file Upload (get is not able to
	 * achieve File upload due to limitation on request size).
	 *
	 ...
	 * management)
	 *
	 * @return the list of HttpData object (attribute and file) to be reused on next
	 *         post
	 */
	private static List<InterfaceHttpData> formpost(Bootstrap bootstrap, String host, int port, URI uriSimple,
		...
		HttpPostRequestEncoder bodyRequestEncoder = new HttpPostRequestEncoder(factory, request, false); // false => not
																											// multipart
		...
		// Do not clear here since we will reuse the InterfaceHttpData on the next
		// request
		// for the example (limit action on client side). Take this as a broadcast of
		// the same
		// request on both Post actions.
		//
		// On standard program, it is clearly recommended to clean all files after each
		// request
