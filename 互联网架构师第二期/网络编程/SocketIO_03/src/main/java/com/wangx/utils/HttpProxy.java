...
public class HttpProxy {
	...
	static {
		...
		RequestConfig rqueseConfig = RequestConfig.custom().setSocketTimeout(HttpProxyConfig.CONNECT_TIMEOUT)
				.setConnectTimeout(HttpProxyConfig.CONNECT_TIMEOUT).build();
		httpClient = HttpClients.custom().setDefaultRequestConfig(rqueseConfig).setConnectionManager(cm).build();
	}
	...
	public static String upload(String requestUrl, String localFile, String username, String password)
		...
		HttpEntity httpEntity = MultipartEntityBuilder.create()
				...
				.addPart("username", usernameInp).addPart("password", passwordInp).build();
		return execute(requestUrl, httpEntity);
	}
